...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<center>
		    <label>KARACHI CITY CLINICAL LABORATORY</label></center>
			<center>
			  <label style = "font-size:12px;">Sir Syed Street, Karachi City</label></center>
			<br />
			<br />
			<div style = "margin-left:50px;" >
				...
				<label style = "margin-left:20px;" >Gender:
						<?php 
							if($f['gender'] == ""){
								echo "<u>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
